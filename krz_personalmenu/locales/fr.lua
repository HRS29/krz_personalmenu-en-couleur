Locales['fr'] = {
	...
	['inventory_use_button'] = '~g~Utiliser',
	['inventory_give_button'] = '~b~Donner',
	...
	['loadout_givemun_button'] = '~g~Donner Munitions',
	['loadout_drop_button'] = '~r~Jeter',

	-- Wallet Menu
	['wallet_title'] = '~y~Portefeuille',
	['wallet_option_give'] = '~b~Donner',
	['wallet_option_drop'] = '~r~Jeter',
	['wallet_job_button'] = '~g~Métier: %s - %s',
	['wallet_job2_button'] = '~r~Organisation: %s - %s',
	['wallet_money_button'] = '~g~Argent: $%s',
	['wallet_bankmoney_button'] = '~w~Banque: $%s',
	['wallet_blackmoney_button'] = '~r~Argent Sale: $%s',
	['wallet_show_idcard_button'] = '~g~Montrer sa carte d\'identité',
	['wallet_check_idcard_button'] = '~b~Regarder sa carte d\'identité',
	['wallet_show_driver_button'] = '~g~Montrer son permis de conduire',
	['wallet_check_driver_button'] = '~b~Regarder son permis de conduire',
	['wallet_show_firearms_button'] = '~g~Montrer son permis port d\'armes',
	['wallet_check_firearms_button'] = '~b~Regarder son permis port d\'armes',

	-- Bills Menu
	['bills_title'] = '~r~Factures',

	-- Clothes Menu
	['clothes_title'] = '~p~Vêtements',
	['clothes_torso'] = '~r~Haut',
	['clothes_pants'] = '~g~Bas',
	['clothes_shoes'] = '~b~Chaussures',
	['clothes_bag'] = '~y~Sac',
	['clothes_bproof'] = '~d~Gilet par Balle',

	-- Accessories Menu
	['accessories_title'] = '~o~Accessoires',
	['accessories_ears'] = '~r~Accessoire d\'Oreilles',
	['accessories_glasses'] = '~b~Lunettes',
	['accessories_helmet'] = '~o~Chapeau/Casque',
	['accessories_mask'] = '~g~Masque',

	-- Animation Menu
	['animation_title'] = '~g~Animations',

	['animation_party_title'] = '~g~Festives',
	...
	['animation_work_title'] = '~o~Travail',
	...
	['animation_mood_title'] = '~y~Humeurs',
	...
	['animation_sports_title'] = '~b~Sports',
	...
	['animation_other_title'] = '~c~Divers',
	...
	['animation_pegi_title'] = '~r~PEGI 21',
	...
	['animation_attitudes_title'] = '~b~Démarche',

	-- Vehicle Menu
	['vehicle_title'] = '~b~Gestion Véhicule',
	['vehicle_engine_button'] = '~g~Allumer~w~/~r~Eteindre le Moteur',
	['vehicle_door_button'] = '~g~Ouvrir~w~/~r~Fermer Porte',
	['vehicle_hood_button'] = '~g~Ouvrir~w~/~r~Fermer Capot',
	['vehicle_trunk_button'] = '~g~Ouvrir/~r~Fermer Coffre',
	...
	['bossmanagement_title'] = '~r~Gestion Entreprise',
	['bossmanagement_chest_button'] = '~r~Coffre Entreprise:',
	['bossmanagement_hire_button'] = '~g~Recruter',
	['bossmanagement_fire_button'] = '~r~Virer',
	['bossmanagement_promote_button'] = '~o~Promouvoir',
	['bossmanagement_demote_button'] = '~u~Destituer',

	-- Boss Management 2 Menu
	['bossmanagement2_title'] = '~y~Gestion Organisation',
	['bossmanagement2_chest_button'] = '~r~Coffre Organisation:',
	['bossmanagement2_hire_button'] = '~g~Recruter',
	['bossmanagement2_fire_button'] = '~r~Virer',
	['bossmanagement2_promote_button'] = '~o~Promouvoir',
	['bossmanagement2_demote_button'] = '~u~Destituer',

	-- Admin Menu
	['admin_title'] = '~u~Administration',
	['admin_goto_button'] = '~b~TP sur Joueur',
	['admin_bring_button'] = '~r~TP Joueur sur moi',
	['admin_tpxyz_button'] = '~g~TP sur Coordonées',
	['admin_noclip_button'] = '~o~NoClip',
	['admin_godmode_button'] = '~b~Mode Invincible',
	['admin_ghostmode_button'] = '~m~Mode Fantôme',
	...
	['admin_givebank_button'] = '~u~S\'octroyer de l\'argent (banque)',
	['admin_givedirtymoney_button'] = '~p~S\'octroyer de l\'argent sale',
	['admin_showxyz_button'] = '~o~Afficher/Cacher Coordonnées',
	['admin_showname_button'] = '~m~Afficher/Cacher Noms des Joueurs',
	['admin_tpmarker_button'] = '~r~TP sur le Marqueur',
	['admin_revive_button'] = '~g~Réanimer un Joueur',
	['admin_changeskin_button'] = '~u~Changer l\'Apparence',
	['admin_saveskin_button'] = '~g~Sauvegarder l\'Apparence'
}